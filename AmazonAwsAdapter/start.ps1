...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a35q70qitjatqg-ats.iot.eu-north-1.amazonaws.com --ca_file root-CA.crt --cert python-simulator.cert.pem --key python-simulator.private.key --client_id basicPubSub --topic sdk/test/python --count 0